...
class FusionCameraDetectionComponent_2 : public apollo::cyber::Component<> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

 public:
  FusionCameraDetectionComponent_2() : seq_num_(0) {}
  ~FusionCameraDetectionComponent_2();

  FusionCameraDetectionComponent_2(const FusionCameraDetectionComponent_2&) =
      delete;
  FusionCameraDetectionComponent_2& operator=(
      const FusionCameraDetectionComponent_2&) = delete;
...
CYBER_REGISTER_COMPONENT(FusionCameraDetectionComponent_2);
