...
#include "modules/prediction/prediction_component_3.h"
...
PredictionComponent_3::~PredictionComponent_3() {}

std::string PredictionComponent_3::Name() const {
  return FLAGS_prediction_module_name;
}

void PredictionComponent_3::OfflineProcessFeatureProtoFile(
...
bool PredictionComponent_3::Init() {
...
bool PredictionComponent_3::Proc(
...
bool PredictionComponent_3::ContainerSubmoduleProcess(
    const std::shared_ptr<PerceptionObstacles>& perception_obstacles) {
  um_dev::profiling::UM_Timing timing("PredictionComponent_3::ContainerSubmoduleProcess");
...
bool PredictionComponent_3::PredictionEndToEndProc(
    const std::shared_ptr<PerceptionObstacles>& perception_obstacles) {
  um_dev::profiling::UM_Timing timing("PredictionComponent_3::PredictionEndToEndProc");
