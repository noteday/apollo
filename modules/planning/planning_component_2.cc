 ...
 *****************************************************************************/
#include "modules/planning/planning_component_2.h"
...
bool PlanningComponent_2::Proc(
  ...
  latest_radar_ts_ = prediction_obstacles->header().has_radar_timestamp() &&
                         ...
                         ? prediction_obstacles->header().radar_timestamp()
                         : latest_radar_ts_;
  um_dev::profiling::UM_Timing timing("PlanningComponent_2::Proc");
...
void PlanningComponent_2::CheckRerouting() {
...
bool PlanningComponent_2::CheckInput() {
